      ...
      >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/readings' as never)} style={styles.seeAllButton}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/live' as never)} style={styles.seeAllButton}>
              <Text style={styles.seeAllText}>See All</Text>
              <View style={{ width: 4 }} />
              <ArrowRight size={14} color={Colors.dark.tint} />
            </TouchableOpacity>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/shop' as never)} style={styles.seeAllButton}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/community' as never)} style={styles.seeAllButton}>
